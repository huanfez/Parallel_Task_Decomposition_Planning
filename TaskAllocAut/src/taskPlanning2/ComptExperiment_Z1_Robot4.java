...
public class ComptExperiment_Z1_Robot4 {
...
//		tsGraph.addEdge(nodet, nodep, new TSEdge("p"));
	...
	public static void main(String args[]) throws ExportException, IOException {
		...
		ArrayList<String> initNode1 = new ArrayList<String>(Arrays.asList("m"));
		...
		ArrayList<String> initNode2 = new ArrayList<String>(Arrays.asList("i"));
		Robot robot2 = new Robot(buildRobotActionList(2), buildTsGraph(2), initNode2);
		ArrayList<String> initNode3 = new ArrayList<String>(Arrays.asList("h"));
		Robot robot3 = new Robot(buildRobotActionList(3), buildTsGraph(3), initNode3);
		Set<Robot> providedRobots1 = new HashSet<>(Arrays.asList(robot2, robot3));
		
		Set<Robot> providedRobots = new HashSet<>(Arrays.asList(robot0, robot1, robot2));

...
public class ComptExperiment_Z3_Robot8 {
...
//		tsGraph.addEdge(nodet, nodep, new TSEdge("p"));
	...
	public static void main(String args[]) throws ExportException, IOException {
		...
		ArrayList<String> initNode5 = new ArrayList<String>(Arrays.asList("h"));
		Robot robot5 = new Robot(buildRobotActionList(5), buildTsGraph(5), initNode5);
		Set<Robot> providedRobots4 = new HashSet<>(Arrays.asList(robot4, robot5));
		
		ArrayList<String> initNode6 = new ArrayList<String>(Arrays.asList("t"));
		...
		Set<Robot> providedRobots5 = new HashSet<>(Arrays.asList(robot6, robot7));

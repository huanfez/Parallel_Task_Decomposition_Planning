...
public class ComptExperiment_Z2_Robot8 {
...
//		tsGraph.addEdge(nodet, nodep, new TSEdge("p"));
	...
	public static void main(String args[]) throws ExportException, IOException {
		...
		ArrayList<String> initNode4 = new ArrayList<String>(Arrays.asList("h"));
		Robot robot4 = new Robot(buildRobotActionList(4), buildTsGraph(4), initNode4);
		Set<Robot> providedRobots0 = new HashSet<>(Arrays.asList(robot0, robot4));
		...
		ArrayList<String> initNode5 = new ArrayList<String>(Arrays.asList("m"));
		Robot robot5 = new Robot(buildRobotActionList(5), buildTsGraph(5), initNode5);
		Set<Robot> providedRobots1 = new HashSet<>(Arrays.asList(robot1, robot5));
		...
		Set<Robot> providedRobots2 = new HashSet<>(Arrays.asList(robot2, robot6));
		...
		Set<Robot> providedRobots3 = new HashSet<>(Arrays.asList(robot3, robot7));
...
//		RegExp regExpr_2 = new RegExp("C((KHR)|(HKR)|(HRK))");
		...
		Automaton globalTaskAutomaton = ShuffleOperations.shuffle(regExpr_1.toAutomaton(), regExpr_2.toAutomaton());

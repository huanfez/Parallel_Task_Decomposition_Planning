...
public class ComptExperiment_Z4_Robot16 {
...
//		tsGraph.addEdge(nodet, nodep, new TSEdge("p"));
	...
	public static void main(String args[]) throws ExportException, IOException {
		...
		ArrayList<String> initNode6 = new ArrayList<String>(Arrays.asList("h"));
		Robot robot6 = new Robot(buildRobotActionList(6), buildTsGraph(6), initNode6);
		Set<Robot> providedRobots0 = new HashSet<>(Arrays.asList(robot0, robot6));
		...
		ArrayList<String> initNode7 = new ArrayList<String>(Arrays.asList("m"));
		Robot robot7 = new Robot(buildRobotActionList(7), buildTsGraph(7), initNode7);
		Set<Robot> providedRobots1 = new HashSet<>(Arrays.asList(robot1, robot7));
		...
		ArrayList<String> initNode8 = new ArrayList<String>(Arrays.asList("h"));
		Robot robot8 = new Robot(buildRobotActionList(8), buildTsGraph(8), initNode8);
		Set<Robot> providedRobots2 = new HashSet<>(Arrays.asList(robot2, robot8));
		...
		ArrayList<String> initNode9 = new ArrayList<String>(Arrays.asList("m"));
		Robot robot9 = new Robot(buildRobotActionList(9), buildTsGraph(9), initNode9);
		Set<Robot> providedRobots3 = new HashSet<>(Arrays.asList(robot3, robot9));
		
		ArrayList<String> initNode4 = new ArrayList<String>(Arrays.asList("t"));
		Robot robot4 = new Robot(buildRobotActionList(4), buildTsGraph(4), initNode4);
		ArrayList<String> initNode10 = new ArrayList<String>(Arrays.asList("h"));
		Robot robot10 = new Robot(buildRobotActionList(10), buildTsGraph(10), initNode10);
		Set<Robot> providedRobots4 = new HashSet<>(Arrays.asList(robot4, robot10));
		
		ArrayList<String> initNode5 = new ArrayList<String>(Arrays.asList("t"));
		Robot robot5 = new Robot(buildRobotActionList(5), buildTsGraph(5), initNode5);
		ArrayList<String> initNode11 = new ArrayList<String>(Arrays.asList("m"));
		Robot robot11 = new Robot(buildRobotActionList(11), buildTsGraph(11), initNode11);
		Set<Robot> providedRobots5 = new HashSet<>(Arrays.asList(robot5, robot11));
		
		ArrayList<String> initNode12 = new ArrayList<String>(Arrays.asList("t"));
		Robot robot12 = new Robot(buildRobotActionList(12), buildTsGraph(12), initNode12);
		ArrayList<String> initNode13 = new ArrayList<String>(Arrays.asList("h"));
		Robot robot13 = new Robot(buildRobotActionList(13), buildTsGraph(13), initNode13);
		Set<Robot> providedRobots6 = new HashSet<>(Arrays.asList(robot12, robot13));
		
		ArrayList<String> initNode14 = new ArrayList<String>(Arrays.asList("t"));
		Robot robot14 = new Robot(buildRobotActionList(14), buildTsGraph(14), initNode14);
		ArrayList<String> initNode15 = new ArrayList<String>(Arrays.asList("m"));
		Robot robot15 = new Robot(buildRobotActionList(15), buildTsGraph(15), initNode15);
		Set<Robot> providedRobots7 = new HashSet<>(Arrays.asList(robot14, robot15));
...
//			add('g');
		...
		for (int index = 0; index < 1; index++) {
			...
			robotSetSwitchManned.autRobotsPair.add(
					new RobotConfig(new TaskAutomaton(decompositionSet.get(index).get(2)), providedRobots0));
			robotSetSwitchManned.autRobotsPair.add(
					new RobotConfig(new TaskAutomaton(decompositionSet.get(index).get(3)), providedRobots1));
			robotSetSwitchManned.autRobotsPair.add(
					new RobotConfig(new TaskAutomaton(decompositionSet.get(index).get(2)), providedRobots2));
			robotSetSwitchManned.autRobotsPair.add(
					new RobotConfig(new TaskAutomaton(decompositionSet.get(index).get(3)), providedRobots3));
			robotSetSwitchManned.autRobotsPair.add(
					new RobotConfig(new TaskAutomaton(decompositionSet.get(index).get(2)), providedRobots4));
			robotSetSwitchManned.autRobotsPair.add(
					new RobotConfig(new TaskAutomaton(decompositionSet.get(index).get(3)), providedRobots5));
			robotSetSwitchManned.autRobotsPair.add(
					new RobotConfig(new TaskAutomaton(decompositionSet.get(index).get(2)), providedRobots6));
			robotSetSwitchManned.autRobotsPair.add(
					new RobotConfig(new TaskAutomaton(decompositionSet.get(index).get(3)), providedRobots7));

...
public class ComptExperiment_Z4_Robot8 {
...
//		tsGraph.addEdge(nodet, nodep, new TSEdge("p"));
	...
	public static void main(String args[]) throws ExportException, IOException {
		...
		Set<Robot> providedRobots4 = new HashSet<>(Arrays.asList(robot4));
		...
		Set<Robot> providedRobots5 = new HashSet<>(Arrays.asList(robot5));
		...
		Set<Robot> providedRobots6 = new HashSet<>(Arrays.asList(robot12));
		...
		Set<Robot> providedRobots7 = new HashSet<>(Arrays.asList(robot14));

...
public class ComptExperiment_centralized_Z4_Robot2 {
...
//		ArrayList<String> initNode2 = new ArrayList<String>(Arrays.asList("m"));
//		Robot robot2 = new Robot(buildRobotActionList(2), buildTsGraph(2), initNode2);
//		
//		ArrayList<String> initNode3 = new ArrayList<String>(Arrays.asList("n"));
...
//		
//		ArrayList<String> initNode5 = new ArrayList<String>(Arrays.asList("j"));
//		Robot robot5 = new Robot(buildRobotActionList(5), buildTsGraph(5), initNode5);
		...
		RegExp regExpr_3 = new RegExp("(M((IHQ)|(HIQ)|(HQI)))|(H((QMI)|(MIQ)|(MQI)))");
		RegExp regExpr_4 = new RegExp("(J((NTG)|(TNG)|(TGN)))|(T((GJN)|(JNG)|(JGN)))");
		Automaton globalTaskAutomaton2 = ShuffleOperations.shuffle(regExpr_3.toAutomaton(), regExpr_4.toAutomaton());
		Automaton globalTaskAutomaton = ShuffleOperations.shuffle(globalTaskAutomaton1, globalTaskAutomaton2);

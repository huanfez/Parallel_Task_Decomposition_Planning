...
public class ComptExperiment_Z4_Robot2 {
...
//			add('g');
		...
		Set<Automaton> SubautomatonSet= SubAutomataExtract.commonEventsAut(globalTaskAutomaton1);
		...
		for (int index = 0; index < 1; index++) {
			...
			robotSetSwitchManned.autRobotsPair.add(
					new RobotConfig(new TaskAutomaton(globalTaskAutomaton1), providedRobots0));
			robotSetSwitchManned.autRobotsPair.add(
					new RobotConfig(new TaskAutomaton(globalTaskAutomaton2), providedRobots1));

...
public class ComptExperiment3 {
	...
	private static Graph<ArrayList<String>, TSEdge> buildTsGraph(int index) {
		...
		///////////////////////////////////////////////
		tsGraph.addEdge(nodea, nodeb, new TSEdge("b"));
		tsGraph.addEdge(nodea, nodec, new TSEdge("c"));
		tsGraph.addEdge(nodea, noded, new TSEdge("d"));
		tsGraph.addEdge(nodea, nodee, new TSEdge("e"));
		
		tsGraph.addEdge(nodeb, nodef, new TSEdge("f"));
		tsGraph.addEdge(nodeb, nodeg, new TSEdge("g"));
		tsGraph.addEdge(nodeb, nodeh, new TSEdge("h"));
		
		tsGraph.addEdge(nodec, nodei, new TSEdge("i"));
		tsGraph.addEdge(nodec, nodej, new TSEdge("j"));
		tsGraph.addEdge(nodec, nodek, new TSEdge("k"));
		
		tsGraph.addEdge(noded, nodel, new TSEdge("l"));
		tsGraph.addEdge(noded, nodem, new TSEdge("m"));
		tsGraph.addEdge(noded, noden, new TSEdge("n"));
		tsGraph.addEdge(noded, nodeo, new TSEdge("o"));
		
		tsGraph.addEdge(nodee, nodep, new TSEdge("p"));
		tsGraph.addEdge(nodee, nodeq, new TSEdge("q"));
		tsGraph.addEdge(nodee, noder, new TSEdge("r"));
		
		tsGraph.addEdge(nodef, nodei, new TSEdge("i"));
		tsGraph.addEdge(nodef, nodej, new TSEdge("j"));
		tsGraph.addEdge(nodef, nodek, new TSEdge("k"));
		
		tsGraph.addEdge(nodeg, nodel, new TSEdge("l"));
		tsGraph.addEdge(nodeg, nodem, new TSEdge("m"));
		tsGraph.addEdge(nodeg, noden, new TSEdge("n"));
		tsGraph.addEdge(nodeg, nodeo, new TSEdge("o"));
		
		tsGraph.addEdge(nodeh, nodep, new TSEdge("p"));
		tsGraph.addEdge(nodeh, nodeq, new TSEdge("q"));
		tsGraph.addEdge(nodeh, noder, new TSEdge("r"));
		...
		tsGraph.addEdge(nodej, nodeo, new TSEdge("o"));
		
		tsGraph.addEdge(nodek, nodes, new TSEdge("s"));
		tsGraph.addEdge(nodek, nodet, new TSEdge("t"));
		...
		tsGraph.addEdge(nodem, nodek, new TSEdge("k"));
		
		tsGraph.addEdge(noden, nodep, new TSEdge("p"));
		tsGraph.addEdge(noden, nodeq, new TSEdge("q"));
		tsGraph.addEdge(noden, noder, new TSEdge("r"));
		
		tsGraph.addEdge(nodeo, nodes, new TSEdge("s"));
		tsGraph.addEdge(nodeo, nodet, new TSEdge("t"));
		...
		tsGraph.addEdge(nodeq, nodeo, new TSEdge("o"));
		
		tsGraph.addEdge(noder, nodes, new TSEdge("s"));
		tsGraph.addEdge(noder, nodet, new TSEdge("t"));
		
		tsGraph.addEdge(nodes, nodet, new TSEdge("t"));
		
		tsGraph.addEdge(nodet, nodea, new TSEdge("a"));
		tsGraph.addEdge(nodet, nodeb, new TSEdge("b"));
		tsGraph.addEdge(nodet, nodec, new TSEdge("c"));
		tsGraph.addEdge(nodet, noded, new TSEdge("d"));
		tsGraph.addEdge(nodet, nodee, new TSEdge("e"));
